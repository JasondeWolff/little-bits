...
impl ImGui {
    ...
    pub fn resize(&mut self, dimensions: Int2) {
        self.context.io_mut().display_size[0] = dimensions.x as f32;
        self.context.io_mut().display_size[1] = dimensions.y as f32;
    }
    ...
    pub fn mouse_pos_event(&mut self, pos: Float2) {
...
// Source: https://docs.rs/crate/imgui-opengl-renderer/0.12.0/source/src/lib.rs
struct Renderer {
    program: GLuint,
    locs: Locations,
    vbo: GLuint,
